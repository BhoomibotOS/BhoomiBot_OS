...
export function Services() {
  return (
    <section id="services" className="py-16 sm:py-24 bg-slate-950 text-white relative overflow-hidden">
      ...
      <div className="w-full max-w-[1800px] mx-auto px-4 sm:px-8 lg:px-12 xl:px-16 relative z-10">
        <div className="flex flex-col items-center text-center mb-12 sm:mb-16">
          ...
          <h2 className="text-3xl md:text-5xl font-black tracking-tighter mb-4 sm:mb-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
          {serviceCategories.map((service, index) => (
            <motion.div
              ...
              className="group relative bg-zinc-900/90 rounded-3xl sm:rounded-[2.5rem] p-6 sm:p-8 border border-white/10 hover:border-primary/50 transition-all duration-300 flex flex-col justify-between shadow-2xl hover:shadow-primary/10"
            >
              <div>
                <div className="flex items-center justify-between mb-6">
                  <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-primary/10 border border-primary/20 flex items-center justify-center text-primary group-hover:scale-110 transition-transform duration-300">
                    <service.icon size={24} className="sm:hidden" />
                    <service.icon size={28} className="hidden sm:block" />
                  </div>
                ...
                <h3 className="text-xl sm:text-2xl font-black tracking-tight mb-3 group-hover:text-primary transition-colors">
                  {service.title}
                </h3>
        ...
        {/* Bottom Banner */}
        <div className="mt-12 sm:mt-16 p-6 sm:p-10 rounded-3xl sm:rounded-[2.5rem] bg-gradient-to-r from-zinc-900 via-zinc-950 to-zinc-900 border border-white/10 relative overflow-hidden flex flex-col md:flex-row items-center justify-between gap-6 sm:gap-8">
